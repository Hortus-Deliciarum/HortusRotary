// -----
// HortusRotary.h - Library for using rotary encoders.
...
#ifndef HortusRotary_h
#define HortusRotary_h
...
public:
    ...
    // ----- Constructor -----
    HortusRotary(int pin1, int pin2, LatchMode mode = LatchMode::FOUR0);
